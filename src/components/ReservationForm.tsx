                ...
                <div className="space-y-3 pt-4 border-t border-slate-100">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <select 
                      ...
                      className="w-full p-3 bg-slate-50 rounded-xl text-sm outline-none focus:ring-1 focus:ring-[#d4af37]"
                    >
                  ...
                  <button type="submit" className="w-full bg-[#0a192f] text-white py-4 rounded-2xl font-bold hover:bg-[#d4af37] transition-all shadow-lg active:scale-95 uppercase tracking-widest text-xs">
                    Odeslat rezervaci
                  </button>
                </div>
              </form>
